...
#define PRINT_IPV6(a) printk(KERN_INFO"%x:%x:%x:%x:%x:%x:%x:%x\n", ASF_NTOHS(a.s6_addr16[0]), ASF_NTOHS(a.s6_addr16[1]), ASF_NTOHS(a.s6_addr16[2]), ASF_NTOHS(a.s6_addr16[3]), ASF_NTOHS(a.s6_addr16[4]), ASF_NTOHS(a.s6_addr16[5]), ASF_NTOHS(a.s6_addr16[6]), ASF_NTOHS(a.s6_addr16[7]))
#define PRINT_IPV6_OTH(a) ASF_NTOHS(a.s6_addr16[0]), ASF_NTOHS(a.s6_addr16[1]), ASF_NTOHS(a.s6_addr16[2]), ASF_NTOHS(a.s6_addr16[3]), ASF_NTOHS(a.s6_addr16[4]), ASF_NTOHS(a.s6_addr16[5]), ASF_NTOHS(a.s6_addr16[6]), ASF_NTOHS(a.s6_addr16[7])
